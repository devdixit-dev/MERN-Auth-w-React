      ...
      {!isEmailSent &&
        ...
        <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
          ...
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            ...
            <input type="email" placeholder='Email' className='outline-0 bg-transparent text-white' value={email} onChange={e => setEmail(e.target.value)} required />
          </div>
      ...
      {isOtpSubmitted && isEmailSent &&
        <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
          ...
          <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
            ...
            <input type="email" placeholder='Password' className='outline-0 bg-transparent text-white' value={newPassword} onChange={e => setNewPassword(e.target.value)} required />
          </div>
          <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3'>Set new password</button>
        </form>
      }
